...
contract TokenFactory {
    ...
    function readERC20Owner(address _erc20Address)
        public
        view
        returns (address)
    {
    ...
    function erc20BalanceOf(address _erc20Address)
        public
        view
        returns (uint256)
    {
    ...
    function getERC20Name(address _erc20Address)
        public
        view
    ...
    function getERC20Symbol(address _erc20Address)
        public
        view
        returns (string memory)
    {
    ...
    function getERC20TotalSupply(address _erc20Address)
        public
        view
        returns (uint256)
    {
